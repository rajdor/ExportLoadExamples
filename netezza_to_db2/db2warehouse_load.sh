...
echo "NOTE :"
echo ""
echo "         Substring used in SQL check (rather than comparison using Insert equivalent SQL) due to ctrl chars concatenation leading to Nulls"
echo ""
echo "         Load will replace ASCII 128  -> ASCII 163 with ASCII 194"
echo "         Load will replace ASCII 164               with ASCII 226"
echo "         Load will replace ASCII 192  -> ASCII 255 with ASCII 195"
echo "         Load will replace ASCII 165* -> ASCII 191 with ASCII 194"
echo "         Load will replace ASCII 166               with ASCII 197"
echo "         Load will replace ASCII 168               with ASCII 197"
echo "         Load will replace ASCII 180               with ASCII 197"
echo "         Load will replace ASCII 184               with ASCII 197"
echo "         Load will replace ASCII 188               with ASCII 197"
echo "         Load will replace ASCII 189               with ASCII 197"
echo "         Load will replace ASCII 190               with ASCII 197"
echo ""
